...
-   **Frequency Spectrum Analysis**: Analyzes FFT output to find dominant frequency peaks in the walking range. Peak magnitude threshold of 0.0025 (normalized, calibrated to filter sensor noise showing 0.003 when stationary) determines walking vs. stationary state.
