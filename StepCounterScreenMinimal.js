...
export default function StepCounterScreenMinimal() {
  ...
  // Single consolidated useEffect - exactly like the progressive test that worked
  useEffect(() => {
    ...
    const initializeAll = async () => {
      try {
        ...
        // Phase 3: Callbacks - auto-accept walking detection
        if (isMounted.current) {
