...
export default function StepCounterScreenDelayed() {
  ...
  // KEY FIX: Mount first, initialize after delay
  useEffect(() => {
    isMounted.current = true;
    console.log('Component mounted, waiting 500ms before init...');
    
    // Delay initialization to let component fully mount (like progressive test)
